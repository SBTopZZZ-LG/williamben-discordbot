								...
								session.globalVotersCount === 0
									...
									: {
										text: `${(session.globalVotersCount >
											...
											.join(", ")}${session.globalVotersCount > 6
												? ` and ${session.globalVotersCount -
												6
												} other people`
												: ""
					...
					embeds: [
						new EmbedBuilder()
							...
							.addFields(
								...
								{
									name: "qs <input>",
									value: "```Compute the Quicksort for specified <input>. <input> can either be a string without whitespaces, or a list of integers seperated with whitespaces.\n\nExample: wbb!qs VTUBELAGAVI```",
								},
								{
								...
								new EmbedBuilder()
									...
									.setFooter(
										session.globalVoters.length === 0
											? {}
											: {
												text: `This poll lasted for about ${Date.now() -
